...
| `split_refused` | Split refused for neither of the two causes above — currently only a terminal below the layout threshold. Deprecated as a diagnosis (#335) and kept for compatibility with clients that still match it; treat it as *cause unknown*. |
